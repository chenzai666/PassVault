...
const ru: Record<string, string> = {
  ...
  "txt_loading_nodewarden": "Загрузка PassVault...",
  ...
  "txt_nodewarden_send": "PassVault Отправить",
  ...
  "txt_online": "Онлайн",
  "txt_offline": "Офлайн",
  "txt_offline_vault_readonly": "Автономный режим доступен только для чтения. Подключитесь к PassVault, чтобы изменить хранилище.",
