...
const OFFLINE_FALLBACK_HTML = '<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>PassVault</title><style>html,body{height:100%;margin:0;background:#f3ede6;color:#1f1b16;font-family:ui-sans-serif,system-ui,sans-serif}.boot-screen{min-height:100%;display:grid;place-items:center;padding:24px;box-sizing:border-box}.boot-card{width:min(420px,100%);display:grid;gap:12px;justify-items:center;padding:28px;border:1px solid rgba(139,104,72,.20);border-radius:22px;background:rgba(255,253,250,.92);box-shadow:0 20px 45px rgba(52,41,31,.10)}.boot-logo{width:74px;height:58px;object-fit:contain}.boot-title{font-weight:700}.boot-sub{color:#6a6156;text-align:center;font-size:14px;line-height:1.5}</style></head><body><div class="boot-screen"><div class="boot-card"><img class="boot-logo" src="/nodewarden-logo.svg" alt=""><div class="boot-title">PassVault</div><div class="boot-sub">Offline cache is not ready on this device. Open PassVault once while online, then try offline again.</div></div></div></body></html>';
