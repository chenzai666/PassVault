...
const es: Record<string, string> = {
  ...
  "txt_loading_nodewarden": "Cargando PassVault...",
  ...
  "txt_nodewarden_send": "Envío PassVault",
  ...
  "txt_offline_vault_readonly": "El modo sin conexión es de solo lectura. Conecta con PassVault antes de cambiar la bóveda.",
  "txt_submit": "Enviar",
