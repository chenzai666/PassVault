...
const zhCN: Record<string, string> = {
  ...
  "txt_loading": "加载中...",
  "txt_loading_nodewarden": "正在加载 PassVault...",
  ...
  "txt_no_verification_codes": "暂无验证码。在密码库中为登录项目添加 TOTP 密钥后，验证码将在此处自动显示。",
  "txt_no_name": "（无名称）",
  ...
  "txt_online": "在线",
  "txt_offline": "离线",
  "txt_offline_vault_readonly": "当前为离线模式，只能查看密码库。连接到 PassVault 后才能修改。",
  "txt_submit": "提交",
  "txt_sync": "同步",
  "txt_sync_vault": "同步",
