...
const zhTW: Record<string, string> = {
  ...
  "txt_backup_recommend_infinicloud_step_4": "在 My Page 最下面的 Referral Bonus 填入推薦碼 RSRQP，可額外獲得 5 GB。",
  ...
  "txt_loading": "加載中...",
  "txt_loading_nodewarden": "正在加載 PassVault...",
  ...
  "txt_online": "在線",
  "txt_offline": "離線",
  "txt_offline_vault_readonly": "目前為離線模式，只能查看密碼庫。連線到 PassVault 後才能修改。",
  "txt_submit": "提交",
  "txt_sync": "同步",
  "txt_sync_vault": "同步",
